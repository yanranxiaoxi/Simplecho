...
<li id="<?php $comments->theId(); ?>" class="comment-body<?php
	...
	<div class="comment-content">
		...
		<?php echo preg_replace('#\@\((.*?)\)#', '<img src="https://cdn.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.0/img/alu/$1.png">', $comments->content); // 替换关键词为表情 ?>
	</div>
		...
		<form method="post" action="<?php $this->commentUrl(); ?>" id="comment-form" role="form" class="comment-form">
			<div class="center">
				...
				<p style="margin-top: 20px;">
					<!-- <span style="position:absolute; bottom:21px; cursor:pointer;" id="smiliesbutton" title="选择表情"><img src="https://cdn.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.0/img/alu/icon_smile.gif" alt="选择表情" style="width:1.3em; height:1.3em; vertical-align:middle;"><span style="font-size:13px;">选择表情</span></span> -->
					<div class="OwO"></div>
...
<script>
	var OwO_demo = new OwO({
		...
		api: 'https://cdn.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.0/js/OwO.json',
		position: 'down',
		width: '100%',
		maxHeight: '250px'
	});
...
{regExp=new RegExp('{'+k+'}','g');html=html.replace(regExp,v);});var reg1=/@\(([^ ]*)\)/g;html=html.replace(reg1,"<img src=\"\https://cdn.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.0/img/alu/$1.png\"\>");$(html).prependTo(el);}
