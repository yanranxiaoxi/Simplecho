...
<li id="<?php $comments->theId(); ?>" class="comment-body<?php
	...
	<div class="comment-content">
		...
		<?php echo preg_replace('#\@\((.*?)\)#', '<img src="https://cdn.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.16/images/alu/$1.png">', $comments->content); // 替换关键词为表情 ?>
	</div>
...
<script>
	var OwO_demo = new OwO({
		...
		api: 'https://cdn.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.16/assets/json/OwO.json',
		position: 'down',
		width: '100%',
		maxHeight: '250px'
	});
...
{regExp=new RegExp('{'+k+'}','g');html=html.replace(regExp,v);});var reg1=/@\(([^ ]*)\)/g;html=html.replace(reg1,"<img src=\"https://cdn.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.16/images/alu/$1.png\"\>");$(html).prependTo(el);}
