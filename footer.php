			...
			<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.20/assets/js/img-lazy.min.js"></script>
			<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.20/assets/js/moment.min.js"></script>
			...
			<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.20/assets/css/noticejs.min.css" />
			...
			<script defer type="text/javascript" src="https://cdn.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.20/assets/js/lamu-leimu.min.js"></script>
			<?php endif; ?>
		</div>
	</div>
	<?php $this->footer(); ?>
