...
function parseContent($obj) {
	...
	$obj->content = preg_replace('/<\s*img[\s\S]+?(?:src=[\'"]([\S\s]*?)[\'"]\s*|alt=[\'"]([\S\s]*?)[\'"]\s*|[a-z]+=[\'"][\S\s]*?[\'"]\s*)+[\s\S]*?>/i','<img src="https://fastly.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.3/img/lazyload.jpg" alt="$2" data-src="$1" />',$obj->content);
