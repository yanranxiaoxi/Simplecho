...
<head>
	...
	<?php else: ?>
	<link href="https://fastly.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.5/img/icon.ico" rel="shortcut icon" />
	<?php endif; ?>
	<link rel="stylesheet" href="https://cdn.staticfile.org/font-awesome/6.1.1/css/all.min.css" />
	<link rel="stylesheet" href="https://fastly.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.5/css/main.min.css" />
	<?php if ($this->options->topnavO == '0'): ?>
	<link rel="stylesheet" href="https://fastly.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.5/css/gray.min.css" />
	<?php elseif ($this->options->topnavO == '1'): ?>
	<link rel="stylesheet" href="https://fastly.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.5/css/white.min.css" />
	<?php elseif ($this->options->topnavO == '2'): ?>
	<link rel="stylesheet" href="https://fastly.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.5/css/black.min.css" />
	<?php elseif ($this->options->topnavO == '3'): ?>
	<link rel="stylesheet" href="https://fastly.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.5/css/green.min.css" />
	<?php else: ?>
	<link rel="stylesheet" href="https://fastly.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.5/css/gray.min.css" />
	<?php endif; ?>
	...
	<link rel="stylesheet" href="https://fastly.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.5/css/OwO.min.css" />
	...
	<script type="text/javascript" src="https://fastly.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.5/js/jQuery.scrollLoad.min.js"></script>
	<script type="text/javascript" src="https://cdn.staticfile.org/jquery.pjax/2.0.1/jquery.pjax.min.js"></script>
	<script type="text/javascript" src="https://fastly.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.5/js/OwO.min.js"></script>
			...
			<nav class="navbar navbar-expand-lg">
				<a href="<?php $this->options->siteUrl(); ?>">
					<div class="navbar-brand">
						...
						<?php else: ?>
						<img class="user-avatar" src="https://fastly.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.5/img/avatar.png" alt="头像" />
						<?php endif; ?>
