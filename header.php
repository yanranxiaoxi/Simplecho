...
<head>
	...
	<?php else: ?>
	<link href="https://cdn.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.18/images/icon.ico" rel="shortcut icon" />
	<?php endif; ?>
	<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.6.0/css/all.min.css" />
	<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.18/assets/css/main.min.css" />
	<?php if ($this->options->themeColor == '0'): ?>
	<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.18/assets/css/gray.min.css" />
	<?php elseif ($this->options->themeColor == '1'): ?>
	<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.18/assets/css/white.min.css" />
	<?php elseif ($this->options->themeColor == '2'): ?>
	<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.18/assets/css/green.min.css" />
	<?php elseif ($this->options->themeColor == '3'): ?>
	<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.18/assets/css/black.min.css" />
	<?php else: ?>
	<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.18/assets/css/gray.min.css" />
	<?php endif; ?>
	<?php if ($this->options->themeAutoDark === 'enable'): ?>
	<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.18/assets/css/dark.min.css" />
	<?php endif; ?>
	...
	<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.18/assets/js/jQuery.scrollLoad.min.js"></script>
			...
			<nav class="navbar navbar-expand-lg">
				<a href="<?php $this->options->siteUrl(); ?>">
					<div class="navbar-brand">
						...
						<?php else: ?>
						<img class="user-avatar" src="https://cdn.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.18/images/avatar.png" alt="头像" />
						<?php endif; ?>
