 ...
 */
!function(t){"function"==typeof define&&define.amd?define(t):t()}((function(){"use strict";var t;!function(t,e){void 0===e&&(e={});var n=e.insertAt;if(t&&"undefined"!=typeof document){var i=document.head||document.getElementsByTagName("head")[0],o=document.createElement("style");o.type="text/css","top"===n&&i.firstChild?i.insertBefore(o,i.firstChild):i.appendChild(o),o.styleSheet?o.styleSheet.cssText=t:o.appendChild(document.createTextNode(t))}}("@media (max-width:860px){.sidebar_wo{display:none}}.sidebar_wo{position:fixed;bottom:0;z-index:1000;line-height:0;cursor:url(https://fastly.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.4/img/cursor/leimu.cur),pointer}#lamu{right:0;-webkit-transition:all .3s ease-in-out;-o-transition:all .3s ease-in-out;transition:all .3s ease-in-out;-webkit-transform:translate(7px,7px);-ms-transform:translate(7px,7px);transform:translate(7px,7px)}#lamu:hover{-webkit-transform:translate(0);-ms-transform:translate(0);transform:translate(0)}#leimu{left:0;-webkit-transition:all .3s ease-in-out;-o-transition:all .3s ease-in-out;transition:all .3s ease-in-out;-webkit-transform:translate(-7px,7px);-ms-transform:translate(-7px,7px);transform:translate(-7px,7px)}#leimu:hover{-webkit-transform:translate(0);-ms-transform:translate(0);transform:translate(0)}"),(t=document.createElement("div")).innerHTML='<div class="sidebar_wo" id="leimu"><img src="https://fastly.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.4/img/bottom/leimu1.png" alt="雷姆" onmouseover="this.src=\'https://fastly.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.4/img/bottom/leimu2.png\'" onmouseout="this.src=\'https://fastly.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.4/img/bottom/leimu1.png\'"></div><div class="sidebar_wo" id="lamu"><img src="https://fastly.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.4/img/bottom/lamu1.png" alt="拉姆" onmouseover="this.src=\'https://fastly.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.4/img/bottom/lamu2.png\'" onmouseout="this.src=\'https://fastly.jsdelivr.net/gh/yanranxiaoxi/Simplecho@0.1.4/img/bottom/lamu1.png\'"></div>',t.id="lamu-leimu",document.body.appendChild(t),document.getElementById("lamu").onclick=function(){return window.scrollTo({top:0,behavior:"smooth"}),!1},document.getElementById("leimu").onclick=function(){return window.scrollTo({top:document.documentElement&&document.documentElement.scrollHeight||document.body.scrollHeight,behavior:"smooth"}),!1}}));
